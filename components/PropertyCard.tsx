  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <button
          className="absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-saffron hover:text-white transition-all duration-300 group/wishlist"
      ...
      <div className="p-6">
        ...
        {/* Title */}
        <h3 className="text-xl font-serif font-semibold text-gray-900 mb-2 group-hover:text-saffron transition-colors">
          {property.title}
        </h3>
        ...
        <div className="flex items-center gap-2 text-saffron text-sm mb-4 font-medium">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
          ...
          <button className="px-6 py-2.5 bg-saffron text-white rounded-lg font-medium hover:bg-saffron-dark transition-all duration-300 hover:shadow-lg hover:scale-105">
            View Details
          </button>
        </div>
      </div>
