...
const CALL_NUMBER = '919068464048';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end">
      ...
      <a
        ...
        aria-label="Call Us"
        className="flex items-center justify-center w-14 h-14 rounded-full shadow-2xl bg-blue-600 hover:bg-blue-700 transition-all duration-300 hover:scale-110 group relative"
      >
        <span className="absolute inline-flex w-full h-full rounded-full bg-blue-600 opacity-40 animate-ping group-hover:animate-none" />
      ...
      <button
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full shadow-2xl bg-[#25D366] hover:bg-[#1ebe5d] transition-all duration-300 hover:scale-110 group relative"
      >
        <span className="absolute inline-flex w-full h-full rounded-full bg-[#25D366] opacity-60 animate-ping group-hover:animate-none" />
        <svg
      ...
      {isChatOpen && (
        <>
          ...
          />
          <div className="fixed bottom-24 right-6 z-50 w-80 rounded-2xl shadow-2xl overflow-hidden animate-slide-up origin-bottom-right">
            {/* Header */}
