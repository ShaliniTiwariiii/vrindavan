...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center pt-20 bg-gradient-to-br from-saffron/10 via-cream to-gold/10"
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          {/* Sacred Symbol */}
          <div className="text-6xl md:text-7xl text-saffron mb-6 animate-float">
            ॐ
          </div>
          ...
          <h1 className="font-serif mb-6">
            ...
            <span className="block text-xl md:text-3xl lg:text-4xl text-saffron font-semibold">
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-saffron rounded-full flex items-start justify-center p-2">
            <div className="w-1.5 h-2 bg-saffron rounded-full animate-pulse" />
          </div>
        </div>
      </div>
