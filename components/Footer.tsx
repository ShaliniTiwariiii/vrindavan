        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-4xl text-saffron">ॐ</span>
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-saffron transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="hover:text-saffron transition-colors">
                  Home
                </a>
              </li>
              <li>
                <a href="#properties" className="hover:text-saffron transition-colors">
                  Featured Properties
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 focus:ring-2 focus:ring-saffron focus:border-transparent outline-none text-white placeholder-gray-400"
              />
              <button
                type="submit"
                className="w-10 h-10 bg-saffron rounded-lg flex items-center justify-center hover:bg-saffron-dark transition-colors flex-shrink-0"
